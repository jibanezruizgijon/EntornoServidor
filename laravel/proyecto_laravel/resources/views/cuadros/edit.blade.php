    ...
    @section('content')
        <section class="container-md">
            <div class="row mt-3 justify-content-center">
                <div class="col-md-6">
                    <h1>Editar Cuadro</h1>
                    <form action="{{ route('cuadros.update', $cuadro->id) }}"  class="p-4 bg-primary-subtle border rounded needs-validation" method="post">
                        @csrf
                        @method('PUT')
                        ...
                        <input type="url" id="urlImg" class="form-control" name="urlImg"
                            value="{{ old('urlImg', $cuadro->urlImg) }}"><br><br>
