<x-app>
    @section('title', 'Añadir Nueva Obra')
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7 col-md-9">
                    <div class="card border-0 shadow-lg p-4 p-md-5">
                        ...
                        <h2 class="display-6 fw-bold mb-4 text-center">Añadir Nueva Obra</h2>
                        <hr class="mb-4">
                        ...
                        <form action="{{ route('cuadros.store') }}" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-floating mb-4">
                                <input type="text" class="form-control" id="floatingInputNombre" name="nombre" placeholder="Nombre de la obra" value="{{ old('nombre') }}">
                            ...
                            @enderror
                            <div class="mb-5">
                                <label for="urlImg" class="form-label text-muted ms-1">Selecciona la imagen de la obra:</label>
                                <input type="file" class="form-control form-control-lg" id="urlImg" name="urlImg">
                            </div>

                            <div class="d-grid">
                                <button type="submit" class="btn btn-dark btn-lg">Añadir Obra a la Galería</button>
                            </div>
                        </form>
