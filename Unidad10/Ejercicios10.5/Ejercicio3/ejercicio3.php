...
<body>
    ...
    <div class="container">
        <section class="compra">
            ...
            $consulta = $conexion->query("SELECT id, nombre, precio, imagen, stock, descripcion FROM tiendaZapatos");
            ...
            ?>
                <form action="" method="post">
                    <input type="hidden" name="compra" value="<?= $zapato->id ?>">
                    <input type="submit" value="comprar">
                </form>
                <br>
                <form action="detalles.php" method="post">
                    <input type="hidden" name="detalle" value="<?= $zapato->id ?>">
