    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td></td>
                <td><a href="?pagina=1"><<-Primera </a></td>
                <td><a href="?pagina=<?= ($paginaActual - 1) ?>"><-Anterior </a></td>
                <td><a href="?pagina=<?= ($paginaActual + 1) ?>">->Siguiente</a></td>
                <td><a href="?pagina=<?= $paginas ?>">->>Última</a></td>
            </tr>
